...
<FlashList
  ...
  estimatedItemSize={50} // FlashList v1 only — removed in v2
/>
```

> **Note:** FlashList v2 removed `estimatedItemSize`, `estimatedListSize`, and
> `estimatedFirstItemOffset`. It measures items automatically. Only FlashList v1
> requires `estimatedItemSize`.
...
```jsx
// FlashList v1: calculate average for estimatedItemSize
...
<FlashList
  data={items}
  renderItem={renderItem}
  estimatedItemSize={100} // FlashList v1 only — removed in v2
/>
```

> **Note:** FlashList v2 measures items automatically. Remove `estimatedItemSize`
...
<FlashList
  ...
  estimatedItemSize={80} // FlashList v1 only — removed in v2
/>
```
...
| Fixed height items | Add `getItemLayout` (FlatList) or `estimatedItemSize` (FlashList v1 only) |
...
- **Ignoring estimatedItemSize warning (FlashList v1)**: FlashList v1 warns if not set. FlashList v2 removed this prop entirely—it measures automatically.
