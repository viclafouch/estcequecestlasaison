    ...
    <div className="mb-4 flex flex-col gap-3 md:mb-6 md:flex-row print:hidden">
      ...
      {selectedMonth === null ? (
        ...
        <button
          ...
          className="focus-ring inline-flex shrink-0 self-start items-center gap-2 rounded-full bg-active-100 py-2.5 pr-3 pl-4 text-sm font-medium text-active-700"
